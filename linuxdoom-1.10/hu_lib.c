...
void
HUlib_initSText (hu_stext_t *s, int x, int y, int h, patch_t **font,
...
void
HUlib_addMessageToSText (hu_stext_t *s, char *prefix, char *msg)
{
...
void
HUlib_initIText (hu_itext_t *it, int x, int y, patch_t **font, int startchar,
                 boolean *on)
{
...
void
HUlib_addPrefixToIText (hu_itext_t *it, char *str)
{
  while (*str)
