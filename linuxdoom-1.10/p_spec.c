...
//
int
P_FindSectorFromLineTag (line_t *line, int start)
{
  int i;
...
//
int
P_FindMinSurroundingLight (sector_t *sector, int max)
{
  int i;
  int min;
  line_t *line;
...
//
void
P_CrossSpecialLine (int linenum, int side, mobj_t *thing)
{
  line_t *line;
  int ok;
...
//
void
P_ShootSpecialLine (mobj_t *thing, line_t *line)
{
  int ok;
